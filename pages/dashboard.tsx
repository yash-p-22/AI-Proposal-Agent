  ...
  logs.forEach((log) => {
    ...
    if (!currentRun) {
      ...
      if (runId && currentRun.id === runId) {
        ...
        const t1 = new Date(
          currentRun.logs[currentRun.logs.length - 1].timestamp,
        ).getTime();
    ...
    if (
      (log.metadata as any)?.client &&
      currentRun!.client === "Unknown Business"
    ) {
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          >
                            {p.metadata?.client ?? "Client"} —{" "}
                            {p.metadata?.budget ?? "TBD"}
                          </p>
                          <p
                            style={{
                              fontSize: 11,
                              ...
                              >
                                <div
                                  style={{
                                    ...
                                    borderRadius: "50%",
                                    background:
                                      STEP_COLORS[log.agent_step] ?? "#9ca3af",
                                    marginTop: 6,
                                    flexShrink: 0,
                                  }}
                                />
